...
@section('content')
    ...
    <div class="db-profile-edit">
        <form action="{{ url('dashboard/room/booking/'.$room_booking->id.'/review/') }}" method="POST" id="ratingsForm" class="col s12">
    @method('POST')
    @csrf
        <div>
            <label class="col s4">Review</label>
            <div class="input-field col s8">
                <textarea name="review" class="review-textarea validate">{{ old('review', $room_booking->review->review ?? '') }}</textarea>
@error('review')
