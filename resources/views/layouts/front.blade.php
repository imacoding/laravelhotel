...
<!--HEADER SECTION-->
<section>
    <div class="menu-section" style="background-color: #E8C57A;">
        <div class="container">
...
@if(Session::has('flash_message'))
    <div id="flash-message" class="alert alert-success" style="position: absolute; top: 0; right: 0; opacity: 0.8;">
...
<script>
    $(document).ready(function() {
        $('#flash-message').delay(2000).addClass('fade').queue(function(){
            $(this).remove();
        });
    });
</script>
