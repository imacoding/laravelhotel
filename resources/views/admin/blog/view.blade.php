            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="content">
                            <div class="toolbar">
                                <a href="{{url('admin/blog/create')}}" rel="tooltip" title="Add New blog"
                                    ...
                                    @else
                                        @foreach($blogs as $index => $blog)
                                            <tr>
                                                <td>{{$index+1}}</td>
                                                <td>{{ $blog->name }}</td>
                                                <td><img height="70px" width="70px" rel="tooltip"  alt="{{ $blog->image }}"
                                                         src="{{'/storage/blogs/'.$blog->image}}"/></td>
                                                ...
                                                <td>
                                                    <div class="table-icons">
                                                        <a rel="tooltip" title="Edit"
                                                           ...
                                                           href="{{url('admin/blog/'.$blog->id.'/edit')}}">
                                                        ...
                                                        <div class="collapse">
                                                           <form id="delete-blog" action="{{ url('admin/blog/'.$blog->id) }}" method="POST">
    @csrf
    @method('DELETE')
    ...
    <script type="text/javascript">
        ...
        var delete_button = function(){
            swal({  title: "Are you sure?",
                text: "You want to delete the blog. Deleting blog will also delete all blog bookings.",
                type: "warning",
